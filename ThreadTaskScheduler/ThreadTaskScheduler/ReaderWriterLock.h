...
class ReaderWriterLock
{
    ...
    std::mutex m;
    std::mutex mw;
    void (ReaderWriterLock::* beforeRead)() { &ReaderWriterLock::before_read_msl };
    void (ReaderWriterLock::* afterRead)() { &ReaderWriterLock::after_read_msl };
    void (ReaderWriterLock::* beforeWrite)() { &ReaderWriterLock::before_write_msl };
    void (ReaderWriterLock::* afterWrite)() { &ReaderWriterLock::after_write_msl };
...
public:
    ...
    bool set_lock_style(LockStyle lockStyle)
    {
        ...
        {
            this->beforeRead = &ReaderWriterLock::before_read_msl;
            this->afterRead = &ReaderWriterLock::after_read_msl;
            this->beforeWrite = &ReaderWriterLock::before_write_msl;
            this->afterWrite = &ReaderWriterLock::after_write_msl;
        }
        else if (lockStyle == LockStyle::M2CV)
        {
            this->beforeRead = &ReaderWriterLock::before_read_m2cv;
            this->afterRead = &ReaderWriterLock::after_read_m2cv;
            this->beforeWrite = &ReaderWriterLock::before_write_m2cv;
            this->afterWrite = &ReaderWriterLock::after_write_m2cv;
        }
        else if (lockStyle == LockStyle::NONE)
        {
            this->beforeRead = &ReaderWriterLock::empty_function;
            this->afterRead = &ReaderWriterLock::empty_function;
            this->beforeWrite = &ReaderWriterLock::empty_function;
            this->afterWrite = &ReaderWriterLock::empty_function;
        }
        else ret = false;
        return(ret);
    }
